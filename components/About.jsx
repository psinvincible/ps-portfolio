      ...
      >
        ...
        >
          <p className={`${ovo.className} mb-10 max-w-2xl`}>
            Hello there! Welcome to the universe. I am Prince Prajapati. I’m a dedicated and hardworking person who loves learning new things and improving myself every day. I love building, learning, and improving things that make a real impact.
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
