...
const Header = ({ isDarkMode }) => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      >
        I am a Full-Stack Web Developer. _FRESHER_ Ready to work and adapt new
        technologies. I have used MERN technologies to develop projects.
      </motion.p>
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        <motion.a
          ...
          href="#contact"
          className={`px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 ${isDarkMode ? 'bg-transparent hover:bg-[#2a004a]': ''}`}
        >
          contact me{" "}
          <Image
            src={
